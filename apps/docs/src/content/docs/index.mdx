...
<CardGrid>
  <LinkCard
    ...
    description="Install <code>@use-q/api-client</code> and the React layer"
  />
  <LinkCard
    title="5-minute quick start"
    href="/getting-started/quick-start/"
    description="Build a typed list+create flow"
  />
  <LinkCard
    title="Define a schema"
    href="/getting-started/schema-definition/"
    description="Anatomy of a <code>RouteDefinition</code>"
  />
  <LinkCard
    title="API reference"
    href="/api-reference/route-definition/"
    description="Browse every option and hook"
  />
</CardGrid>
