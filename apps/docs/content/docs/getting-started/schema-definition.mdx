...
refetch consistently. That's [automatic invalidation after mutations](https://tkdodo.eu/blog/automatic-query-invalidation-after-mutations). See [Tag invalidation](/docs/guides/tag-invalidation) for
the full lifecycle.
